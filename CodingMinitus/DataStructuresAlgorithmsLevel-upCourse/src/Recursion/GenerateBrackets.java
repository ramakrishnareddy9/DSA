...
public class GenerateBrackets {
    ...
    static ArrayList<String> generateParentheses1(int n) {
        ArrayList<String> result = new ArrayList<>();
        backtrack1(result, "", 0, 0, n);
        return result;
    }
    
    static void backtrack1(ArrayList<String> result, String current, int open, int close, int n) {
        ...
        if (open < n) {
            backtrack1(result, current + "(", open + 1, close, n);
        }
        
        if (close < open) {
            backtrack1(result, current + ")", open, close + 1, n);
        }
    }
	...
	public static void main(String[] args) {
        ...
        List<String> ans1 = generateParentheses1(n);
        for (String s : ans) {
